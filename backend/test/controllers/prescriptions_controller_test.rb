...
class PrescriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prescription" do
    assert_difference('Prescription.count') do
      post prescriptions_url, params: { prescription: { amount: @prescription.amount, combined_id: @prescription.combined_id, formulation_id: @prescription.formulation_id, ingredient_id: @prescription.ingredient_id, patient_id: @prescription.patient_id } }
    end
  ...
  test "should update prescription" do
    patch prescription_url(@prescription), params: { prescription: { amount: @prescription.amount, combined_id: @prescription.combined_id, formulation_id: @prescription.formulation_id, ingredient_id: @prescription.ingredient_id, patient_id: @prescription.patient_id } }
